...
<head>
    ...
    <title>Clientes :: <?php echo SERVEREMPRESA;?></title>
...
<body>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="input-group-append">
                                        <span data-toggle="tooltip" data-placement="top" title="Registrar Empresa"><a
                                                data-toggle="modal" href="#"
                                                class="btn btn-outline-success form-control registar_empresa_paciente">
                                                <div class="sb-nav-link-icon"></div><i class="fas fa-plus-circle"></i>
                                            </a></span>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="modal_pacientes_empresas">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form class="FormularioAjax" id="formulario_pacientes_empresas" data-async
                        data-target="#rating-modal" action="" method="POST" data-form="" autocomplete="off"
                        enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <input type="hidden" required readonly id="pacientes_empresa_id" name="pacientes_id" />
                                <div class="input-group mb-3">
                                    <input type="text" required readonly id="pro" name="pro" class="form-control" />
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                        ...
                        <div class="form-row">
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <select class="selectpicker" id="pais_id" name="pais_id" required
                                        data-live-search="true" title="País" data-size="5">
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <select class="selectpicker" id="departamento_id" name="departamento_id" required
                                        data-live-search="true" title="Departamentos" data-size="5">
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <select class="selectpicker" id="municipio_id" name="municipio_id" required
                                        data-live-search="true" title="Municipios" data-size="5">
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container-fluid">
        <ol class="breadcrumb mt-2 mb-4">
            ...
            <li class="breadcrumb-item active" id="acciones_factura"><span
                    id="label_acciones_factura"></span>Colaboradores
            </li>
        </ol>
                ...
                <div class="card-body">
                    <form class="form-inline" id="form_main">
                        ...
                        <div class="form-group mx-sm-3 mb-1">
                            ...
                            <button class="btn btn-primary ml-1" type="submit" id="registrar_empresa">
                                <div class="sb-nav-link-icon" data-toggle="tooltip" data-placement="top"
                                    title="Registrar Profesión"></div><i class="fas fa-plus-circle"></i> Registrar
                                Empresa
                            </button>
