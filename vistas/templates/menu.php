...
<nav class="navbar navbar-expand-md navbar-dark bg-primary fixed-top">
    <a class="navbar-brand" href="#"><a href="#"><img src="<?php echo SERVERURL; ?>img/logo.png" width="70px"
                height="45px" alt="" /></a></a>
		...
		?>
            <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown01">
                    <a class="dropdown-item" href="<?php echo SERVERURL; ?>vistas/clientes.php">Colaboradores</a>
